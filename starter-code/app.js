...
// 1. What is "this" when joe.scope() is invoked?
  // 1a. joe.scope() returns a console.log of "this", which is scoped to the "joe" object that was created from the Student constructor

//
// 2. What is "this" when joe.scopeArrow() is invoked?
  // 2a. joe.scopeArrow() returns a console.log of "this", which is scoped to the global scope, in this case the document object

//
// 3. Explain why "this" is different when an arrow function is used.
  // 3a. Arrow functions are not a valid use inside Constructor functions
